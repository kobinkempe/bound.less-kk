// ==================== TEST-ONLY: THE GOLDEN ORACLE =========================
// The retired god-class engine, replaced 2026-07-06 by KobinEngine + LevelMap /
// Document / Camera / TileStore / Renderer. It is kept for ONE reason: three
// suites (KobinEngineV0, geometry/derive, perf.bench.slow) golden-compare the
// extracted engine against it, so a refactor that changes a pixel has to say so.
// It is NOT on any route, NOT imported by the app, and does NOT know about arcs,
// the frame lattice, cedes or scenes — do not read it as a description of the
// current engine. See OPEN-FLAGS cleanup item X3: it is what keeps `clipper-lib`
// in package.json.
// ===========================================================================
...
import { strokeStripNear, clipRingsToRect, clipPolylineToRect, flattenCurve, flattenCurveNear, decimatePolyline } from "../geometry/polyline";
