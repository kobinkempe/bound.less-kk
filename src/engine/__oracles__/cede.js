// =========================== TEST-ONLY =====================================
// No production importer. The float guillotine below was how a parent gave up a
// tile before F22; `Document.cedeTileById` does it with one exact arc boolean
// now. Three suites (cede / derive / seams) still use `cedeRect` as a convenient
// way to MAKE guillotine-cut geometry to test against, which is the only reason
// this file is still here. See OPEN-FLAGS cleanup item X1.
// ===========================================================================
...
import { rectSubtract } from "../geometry/derive";
