// ====================== DEV LAB + ORACLE, NOT PRODUCTION ===================
// The three cubic-pipeline bake SCHEDULES (A batch / B incremental / C crumb).
// Nothing in the engine runs these: a stroke is a biarc chain that resolves to an
// arc perimeter (F21/F22, `geometry/arcPerimeter.js`). Reachable only from the
// /#/bakelab and /#/arcbake dev routes, and from the suites that compare the arc
// bake against this independent implementation.
// ===========================================================================
...
import { cubicAt, circleLoop } from "../geometry/curveOutline";
