/**
 * Regression tests for `polyline.js` - the pure float64 geometry layer. These
 * pin down the exact behaviours the engine's losslessness arguments rest on:
 * flatten fidelity (incl. the collinear-overshoot guard), segment-distance
 * decimation, and the winding compensation in the float ring clip.
 *
