...
import { cubicAt, cubicTangent, splitCubic, chordDeviation, lineCubic,
    fitOffset, capArcs, circleLoop } from "./curveOutline";
...
class DistOracle {
    ...
    /**
     * Distance to the nearest part of the centerline, as measured (no
     * correction), or Infinity when nothing is near.
     *
     * Used to ask "is anything at all closer to this point than the pen radius".
     * A point on the boundary is at exactly r from its OWN generator, so the
     * useful question is never "further than r" — it is "nothing nearer than r",
     * which is what separates a boundary that is clear of other ink from one that
