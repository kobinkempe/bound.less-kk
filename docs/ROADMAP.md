...
| F74 | **fixed 2026-09-08** | the set-scale dialog's Length input drew as a dark bar at the bottom of the screen: a selector left dangling on its comma in the 2026-09-01 cleanup fell through to the toast rule. Deployed broken since then |
